...
```
# ReadAb
A package used to read in antibodies from PDBs numbered with a variety of schemes (Kabat, Chothia, IMGT, AHo), identify the complimentarity-determining loops (CDR loops), display antibody structures, and comparatively analyse loops of many antibodies.
