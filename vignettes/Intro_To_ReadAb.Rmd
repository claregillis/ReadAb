...
```{r}
ab7x94 <- ReadAb::ReadAntibody(pdb = system.file("inst/extdata/7x94_imgt.pdb", package = 'ReadAb'),
                          numbering = "IMGT",
                          heavy = "H",
                          light = "L",
                          antigen = "A")
...
```{r}
ab7x96 <- ReadAb::ReadAntibody(pdb = system.file("inst/extdata/7x96_imgt.pdb", package = "ReadAb"),
                          numbering = "IMGT",
                          heavy = "H",
                          light = "L",
                          antigen = "A")
