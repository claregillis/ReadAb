...
ReadAb::AssessLoopSimilarity(list(ab7x94, ab7x96), 'H1')
```
...
```{r}
ReadAb::VisualizeAntibody(ab7x94, mode = "all_atoms")
```
...
```{r}
H3Similarity <- ReadAb::AssessLoopSimilarity(list(ab7x94, ab7x96), 'H3')
