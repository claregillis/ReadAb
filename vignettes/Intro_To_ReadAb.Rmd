...
```{r}
library(ReadAb)
ab7x94 <- ReadAntibody(pdb = system.file("data/7x96_imgt.pdb", package = ReadAb),
                          numbering = "IMGT",
                          heavy = "H",
                          light = "L",
                          antigen = "A")
...
```{r}
ab7x96 <- ReadAntibody(pdb = "data/7x96_imgt.pdb",
                          numbering = "IMGT",
                          heavy = "H",
                          light = "L",
                          antigen = "A")

AssessLoopSimilarity(c(ab7x94, ab7x96), 'H1')
```
...
```{r}
VisualizeAntibody(ab7x94, mode = "all")
```
...
```{r}
cyanAgAb7x94 <- SetComponentColor(ab7x94, 'antigen', '#42f5dd')
VisualizeAntibody(cyanAgAb7x94, mode = "backbone")
...
```{r}
H3Similarity <- AssessLoopSimilarity(c(ab7x94, ab7x96), 'H3')
